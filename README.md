...
Data should be placed in `data/` with directories for each file type (i.e. all `.xls` files should be placed in the
`data/xls/` directory). GPX files in `.csv` format should be placed under `data/csv/gpx/`. Any `.gpx` files should
