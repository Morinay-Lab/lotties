...
individual_card <- bslib::card(
  ...
  bslib::card_body(
    ...
    shiny::helpText("When you have added all individuals submit your data."),
...
flock_card <- bslib::card(
  ...
  bslib::card_body(
    ...
    shiny::helpText("When you have described all flocks submit your data."),
...
interaction_card <- bslib::card(
  ...
  bslib::card_body(
    ...
    shiny::helpText("When you have added all interactions submit your data."),
